    ...
    <section className="bg-ink-100 py-16 sm:py-20">
      <Container>
        ...
        <div className="mt-10 grid gap-5">
          <article className="rounded-lg bg-ink-950 p-6 text-white sm:p-8">
            <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                <p className="text-sm font-semibold text-brand-amber">Launch support</p>
          ...
          <article className="rounded-lg border border-line bg-white p-6 sm:p-8">
            <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
          ...
          <article className="rounded-lg border border-line bg-white p-6 sm:p-8">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              <div className="flex gap-4">
                <div className="flex size-12 shrink-0 items-center justify-center rounded-lg bg-brand-cyan text-ink-950">
